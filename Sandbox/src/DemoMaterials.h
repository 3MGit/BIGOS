...
BIGOS::Material pearl({ 0.25 , 0.20725, 0.20725, 1.0000 }, { 1.0 , 0.829, 0.829, 1.0000 }, { 0.296648 , 0.296648, 0.296648, 128 * 0.088 });
BIGOS::Material ruby({ 0.1745 , 0.01175, 0.01175, 1.0000 }, { 0.61424 , 0.04136, 0.04136, 1.0000 }, { 0.727811 , 0.626959, 0.626959, 128 * 0.6 });
BIGOS::Material turquoise({ 0.1 , 0.18725, 0.1745, 1.0000 }, { 0.396 , 0.74151, 0.69102, 1.0000 }, { 0.297254 , 0.30829, 0.306678, 128 * 0.1 });
BIGOS::Material brass({ 0.329412 , 0.223529, 0.027451, 1.0000 }, { 0.780392 , 0.568627, 0.113725, 1.0000 }, { 0.992157 , 0.941176, 0.807843, 128 * 0.21794872 });
BIGOS::Material bronze({ 0.2125 , 0.1275, 0.054, 1.0000 }, { 0.714 , 0.4284, 0.18144, 1.0000 }, { 0.393548 , 0.271906, 0.166721, 128 * 0.2 });
BIGOS::Material chrome({ 0.25 , 0.25, 0.25, 1.0000 }, { 0.4 , 0.4, 0.4, 1.0000 }, { 0.774597 , 0.774597, 0.774597, 128 * 0.6 });
BIGOS::Material copper({ 0.19125 , 0.0735, 0.0225, 1.0000 }, { 0.7038 , 0.27048, 0.0828, 1.0000 }, { 0.256777 , 0.137622, 0.086014, 128 * 0.1 });
BIGOS::Material gold({ 0.24725 , 0.1995, 0.0745, 1.0000 }, { 0.75164 , 0.60648, 0.22648, 1.0000 }, { 0.628281 , 0.555802, 0.366065, 128 * 0.4 });
BIGOS::Material silver({ 0.19225 , 0.19225, 0.19225, 1.0000 }, { 0.50754 , 0.50754, 0.50754, 1.0000 }, { 0.508273 , 0.508273, 0.508273, 128 * 0.4 });
